...
# Stripe for payment processing [https://stripe.com/docs/api]
gem "stripe"

# OpenAI for AI analysis [https://github.com/alexrudall/ruby-openai]
gem "ruby-openai"

group :development, :test do
  # Use sqlite locally for faster setup
  gem "sqlite3", ">= 2.1"
